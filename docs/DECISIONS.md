...
| #41 | Local-time temporary Remote rule banner | Kept exact Remote-limit evaluation unchanged but displayed exact override windows in the planner's saved timezone so source-calendar dates cannot make a still-active rule look stale. |
